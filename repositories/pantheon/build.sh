...
# Create repository
REPOSITORY_NAME="pantheon" REPOSITORY_DESCRIPTION="Pantheon Desktop Environment Community Repository"  OUTPUT_DIR="/vagrant/artifacts/pantheon" sabayon-createrepo
